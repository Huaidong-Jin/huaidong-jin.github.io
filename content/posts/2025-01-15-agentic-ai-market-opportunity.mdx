...
<div className="my-8 p-6 bg-gray-100 border-l-4 border-blue-600 rounded">
...
<div className="my-8 p-6 bg-green-50 rounded-lg border-l-4 border-green-500">
...
<div className="my-8 p-6 bg-yellow-100 rounded-lg border-2 border-yellow-500">
...
<th className="p-2.5 border border-gray-300 text-left">Industry</th>
<th className="p-2.5 border border-gray-300 text-center">Impact Level</th>
<th className="p-2.5 border border-gray-300 text-left">Key Use Case</th>
</tr>
</thead>
<tbody>
<tr>
<td className="p-2.5 border border-gray-300"><strong>Insurance</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🔴 Very High</td>
<td className="p-2.5 border border-gray-300">Claims adjudication automation</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>Manufacturing</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟠 High</td>
<td className="p-2.5 border border-gray-300">Inventory & supply chain management</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>Retail</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟠 High</td>
<td className="p-2.5 border border-gray-300">Hyper-personalization at scale</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>Pharmaceuticals</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟡 Medium-High</td>
<td className="p-2.5 border border-gray-300">Drug discovery analytics</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>Financial Services</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟠 High</td>
<td className="p-2.5 border border-gray-300">Compliance & risk automation</td>
</tr>
</tbody>
</table>
...
<thead>
<tr className="bg-yellow-400">
<th className="p-2.5 border border-gray-300 text-left">業界</th>
<th className="p-2.5 border border-gray-300 text-center">インパクトレベル</th>
<th className="p-2.5 border border-gray-300 text-left">主要ユースケース</th>
</tr>
</thead>
<tbody>
<tr>
<td className="p-2.5 border border-gray-300"><strong>保険</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🔴 非常に高い</td>
<td className="p-2.5 border border-gray-300">請求処理の自動化</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>製造業</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟠 高い</td>
<td className="p-2.5 border border-gray-300">在庫・サプライチェーン管理</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>小売</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟠 高い</td>
<td className="p-2.5 border border-gray-300">スケールでのハイパーパーソナライゼーション</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>医薬品</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟡 中〜高</td>
<td className="p-2.5 border border-gray-300">創薬分析</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>金融サービス</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟠 高い</td>
<td className="p-2.5 border border-gray-300">コンプライアンス・リスク自動化</td>
</tr>
</tbody>
</table>
...
<thead>
<tr className="bg-yellow-400">
<th className="p-2.5 border border-gray-300 text-left">行业</th>
<th className="p-2.5 border border-gray-300 text-center">影响级别</th>
<th className="p-2.5 border border-gray-300 text-left">关键用例</th>
</tr>
</thead>
<tbody>
<tr>
<td className="p-2.5 border border-gray-300"><strong>保险</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🔴 非常高</td>
<td className="p-2.5 border border-gray-300">理赔裁决自动化</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>制造业</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟠 高</td>
<td className="p-2.5 border border-gray-300">库存与供应链管理</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>零售</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟠 高</td>
<td className="p-2.5 border border-gray-300">规模化超个性化</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>制药</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟡 中高</td>
<td className="p-2.5 border border-gray-300">药物发现分析</td>
</tr>
<tr>
<td className="p-2.5 border border-gray-300"><strong>金融服务</strong></td>
<td className="p-2.5 border border-gray-300 text-center">🟠 高</td>
<td className="p-2.5 border border-gray-300">合规与风险自动化</td>
</tr>
</tbody>
</table>
